...
function fund() {
    return __awaiter(this, void 0, void 0, function () {
        var amount, walletClient, connectedAccount, publicClient, currentChain, request, hash;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    amount = ethAmountInput.value;
                    console.log("Funding with ".concat(amount, " ETH..."));
                    if (typeof window.ethereum === 'undefined') {
                        connectButton.innerHTML = 'Please install MetaMask';
                        return [2 /*return*/];
                    }
                ...
                case 1:
                    ...
                    console.log('parseEther(amount):', (0, viem_1.parseEther)(amount));
...
function withdraw() {
    return __awaiter(this, void 0, void 0, function () {
        var walletClient, connectedAccount, publicClient, currentChain, request, hash;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
